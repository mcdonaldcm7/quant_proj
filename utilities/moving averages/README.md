# Moving Averages (MAs)
    ...
    *Moving Averages* are a form of **momentum index** in the sense that they do not add new information to an
    ...
    such, it filters out each one of the prices during the past say 20 days and tells us how the **group** of 20 days
